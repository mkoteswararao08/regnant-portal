...
public class SearchEmployee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//same servlet is used for both HR retrive employee details page and Employee view his profile  
	     ...
	     if(ep.employeeId==null)//if employee does not present then employeeId will be null
	     {   	    	 	 
	    	 request.getRequestDispatcher("HRHomePageWithErrorMessage.html").forward(request, response);
	     }
	     else
	     { 
